package com.example.proxy_tool;
...
public class Client {
    public static void main(String[] args) throws Exception {
         ...
         * 此时的apk文件中，dex文件为加密之后的dex，不能查看内容
         */
...
//        apksigner sign  --ks jks文件地址 --ks-key-alias 别名 --ks-pass pass:jsk密码 --key-pass pass:别名密码 --out  out.apk in.apk
        ...
        File jks=new File("proxy_tool/proxy.jks");
        process=Runtime.getRuntime().exec("cmd /c apksigner sign --ks "+jks.getAbsolutePath()
                +" --ks-key-alias xpf --ks-pass pass:xiao112123 --key-pass pass:xiao112123 --out "
